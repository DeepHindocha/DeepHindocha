...
public class DBConnection {
    ...
    static
    {
        try
        {
            Class.forName("oracle.jdbc.OracleDriver");
             conn = DriverManager.getConnection("jdbc:oracle:thin:@//DESKTOP-QDO68OR:1521/XE","mygrocery","mystocks");
    ...
    public static void closeConnection()
    {
        ...
        {
          JOptionPane.showMessageDialog(null,"Erroe in closing the connection!","DB Error!",JOptionPane.ERROR_MESSAGE);
          ex.printStackTrace();
        }
    }
